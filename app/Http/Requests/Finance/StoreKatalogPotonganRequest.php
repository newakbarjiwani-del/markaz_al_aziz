...
class StoreKatalogPotonganRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('katalog-potongan.create') ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'nama' => ['required', 'string', 'max:255', SoftDeleteRules::unique('jenis_potongan', 'nama')],

...
- **Public assets:** Serang `public/pwa`, `templates`, frontend `public/vendor`, missing JS/CSS are copied. Do **not** overwrite Ittihad brand tokens in `public/css/app.css` / `@theme` (primary `#189e61`, accent `#f3ea0e`). Do **not** copy Composer PHP `vendor/` — use `composer install`.

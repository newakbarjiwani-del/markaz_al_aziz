...
<x-admin.datatable-page
    ...
    subtitle="Peringkat siswa berdasarkan total point pelanggaran (tertinggi dulu)"
    :ajax-url="route('admin.prestasi-pelanggaran.rekap-pelanggaran-siswa.data')"
    export-filename="Rekap Pelanggaran Siswa"

@props([
    ...
    'website' => null,
    'instagram' => null,
    'quote' => 'Belajar adalah ibadah. Ilmu yang bermanfaat adalah yang diamalkan dengan akhlak mulia.',
])
...
<div class="id-card id-card--student id-card--back">
        ...
        <div>
            ...
            <ol class="id-card__rules">
                <li>
                    ...
                    <span>Kartu ini adalah identitas resmi pelajar {{ $schoolName }}.</span>
                </li>
                <li>
                    <span class="id-card__rule-num">2</span>
                    <span>Wajib dibawa saat kegiatan belajar dan kegiatan resmi yayasan.</span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <span>Pemegang kartu wajib menjaga nama baik dan etika sebagai pelajar.</span>
                </li>
                <li>
                    <span class="id-card__rule-num">5</span>
                    <span>Berlaku selama status kepesertaan aktif di {{ $schoolName }}.</span>
                </li>
            </ol>
        </div>
    ...
    @if($nis)
        <div class="id-card__qr" title="NIS">
            <span class="id-card__qr-code">{{ $nis }}</span>
        </div>
    @endif

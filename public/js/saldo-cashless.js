(function () {
    ...
    var modal = document.getElementById('saldo-cashless-detail-modal');
    var summaryEl = document.getElementById('saldo-cashless-detail-summary');
    var trxTableEl = document.getElementById('saldo_cashless_trx_table');
    var trxFilterForm = document.getElementById('saldo-cashless-trx-filter-form');
    var trxTable = null;
    ...
    function renderSummary(payload) {
        ...
        summaryEl.innerHTML = '<div class="saldo-detail-modal__meta">'
            ...
            + '<p class="saldo-detail-modal__balance-label">Saldo Cashless</p>'
    ...
    function refreshTrxTableElement() {
        trxTableEl = document.getElementById('saldo_cashless_trx_table');
    }
    ...
    async function openDetail(siswaId, label) {
        ...
        var titleEl = document.getElementById('saldo-cashless-detail-modal-title');
        if (titleEl) {
            titleEl.textContent = label ? 'Detail Saldo Cashless — ' + label : 'Detail Saldo Cashless';
        }
    ...
    document.addEventListener('click', function (event) {
        var button = event.target.closest('[data-cashless-detail]');
        if (!button) return;
    ...
    document.addEventListener('click', function (event) {
        var closeBtn = event.target.closest('[data-modal-close="saldo-cashless-detail-modal"]');
        if (!closeBtn) return;
